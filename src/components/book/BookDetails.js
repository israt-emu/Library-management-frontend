...
const BookDetails = () => {
  ...
  const images = [
    {
      original: "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1386748153l/282035.jpg",
      thumbnail: "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1386748153l/282035.jpg",
    },
    {
      original: "https://media.wiley.com/product_data/coverImage300/6X/11190152/111901526X.jpg",
      thumbnail: "https://media.wiley.com/product_data/coverImage300/6X/11190152/111901526X.jpg",
    },
    {
      original: "https://media.wiley.com/product_data/coverImage300/6X/11190152/111901526X.jpg",
      thumbnail: "https://media.wiley.com/product_data/coverImage300/6X/11190152/111901526X.jpg",
  ...
  return (
    <div className=" mx-auto space-y-12 grid grid-cols-5">
      ...
      <div className="pl-4  col-span-3">
        ...
        <div className="mb-2">{success !== "" && <Success message={success} />}</div>
