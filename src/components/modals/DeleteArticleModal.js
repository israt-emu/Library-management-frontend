...
const DeleteArticleModal = ({deleteArti, setDeleteArti, id}) => {
  const [deleteArticle, {data: deletedData, isSuccess, isError}] = useDeleteArticleMutation();
  ...
  }, [isSuccess, isError, deletedData, setDeleteArti]);
  return (
    deleteArti && (
      <>
          ...
          <div className="relative w-full my-6 mx-auto max-w-3xl px-4 bg-modalBg rounded-lg shadow-lg py-6">
            ...
            <div className="border-0 rounded-lg relative flex flex-col w-full outline-none focus:outline-none">
              ...
              <div className="relative px-4 text-primary flex items-center">
                ...
                <h2 className="text-lg font-medium">Are you sure you want to delete this article?</h2>
              </div>
              <div className="flex justify-end items-center mt-4">
                <button className="text-primary background-transparent font-bold sm:px-2 md:px-6 md:text-sm text-xs py-2  outline-none focus:outline-none mr-2 mb-1" type="button" onClick={() => setDeleteArti(false)}>
                  No
                </button>
