          ...
          <div className="relative w-full my-6 mx-auto max-w-3xl px-4 bg-gray-100 rounded-lg shadow-lg py-6">
            ...
            <div className="border-0 rounded-lg relative flex flex-col w-full outline-none focus:outline-none">
              ...
              <div className="flex justify-end items-center mt-4">
                <button className="text-main background-transparent font-bold sm:px-2 md:px-6 md:text-sm text-xs py-2  outline-none focus:outline-none mr-2 mb-1" type="button" onClick={() => setRequestCount(false)}>
                  No
                </button>
