...
const AdminCard = ({ admin }) => {
  return (
    <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-fill shadow-md">
      <img
        alt=""
        className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full"
        src="https://cdn.pixabay.com/photo/2017/06/29/14/24/teacher-2454399_960_720.jpg"
      />
