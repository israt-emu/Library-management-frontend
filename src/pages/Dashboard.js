  ...
  return (
    <div className={`${theme === "dark" ? "theme-dark" : "theme-light"} bg-fill`}>
      ...
      <div className="grid md:grid-cols-11 gap-2 ">
        ...
        <div className={`text-primary  ${toggle ? "col-start-2 px-4 transition-all duration-300" : "col-start-3 transition-all duration-300 px-8"} col-end-9 h-screen mt-24 z-0`}>
          <Outlet />
        </div>
        <div className={`col-start-10 col-end-12 h-screen fixed top-[52px]  shadow-md  z-50  transition-all duration-300 bg-main`}></div>
      </div>
    </div>
  );
};
